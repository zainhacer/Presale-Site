...
const sttaddr = "0x8ae4c2ca52b9063d0a3de957550f0676e7f35d34";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xA1406b13Ba5f6Ca4E0baF48e63ffb1f432AFEBB4";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xA1406b13Ba5f6Ca4E0baF48e63ffb1f432AFEBB4',
          'symbol': 'OZV',
          'decimals': '18',
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://ozvein.com/?ref=' + document.getElementById('refaddress').value;
}
}
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0xA1406b13Ba5f6Ca4E0baF48e63ffb1f432AFEBB4";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
